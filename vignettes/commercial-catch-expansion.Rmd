...
6. apply length-weight relationship to length distributions and split aggregated landings accordingly. See the [method for expanding lengths ](#expand) section below
