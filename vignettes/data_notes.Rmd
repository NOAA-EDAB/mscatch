...
landings data comes cfdbs > 1992 and from Canada via a github repo. (pre 1992 landings can be 1-10 thousand mt per year)
Length data comes from cfdbs only
